@php
    $languageSwitcherLocales = array_values(array_intersect(['ru', 'en'], config('app.supported_locales', [])));

    if (empty($languageSwitcherLocales)) {
        $languageSwitcherLocales = ['ru', 'en'];
    }

    $languageSwitcherLocales = array_values(array_unique($languageSwitcherLocales));
