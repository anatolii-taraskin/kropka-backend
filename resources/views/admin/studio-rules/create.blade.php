        ...
        >
            ...
            <div class="space-y-6">
                <section class="first-element rounded-xl border border-gray-200 bg-white/40 p-6 shadow-sm space-y-6">
                    ...
                    <div>
                        <x-input-label for="studio_rule_value_ru" :value="__('admin.studio_rules.fields.value_ru')" />

                        <textarea
                            id="studio_rule_value_ru"
                            name="value_ru"
                            rows="5"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required
                            maxlength="2000"
                        >{{ $useOldValues ? old('value_ru') : '' }}</textarea>

                        <x-input-error class="mt-2" :messages="$createErrors->get('value_ru')" />
                    </div>
                </section>
                ...
                <section class="rounded-xl border border-gray-200 bg-white/40 p-6 shadow-sm space-y-6">
                    ...
                    <div>
                        <x-input-label for="studio_rule_value_en" :value="__('admin.studio_rules.fields.value_en')" />

                        <textarea
                            id="studio_rule_value_en"
                            name="value_en"
                            rows="5"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            required
                            maxlength="2000"
                        >{{ $useOldValues ? old('value_en') : '' }}</textarea>

                        <x-input-error class="mt-2" :messages="$createErrors->get('value_en')" />
                    </div>
                </section>
            </div>
